...
form.full<- Acc ~ Coh + Speed + PatternType + Coh*Speed*PatternType + (1|SubID)
...
form.acc.logit<- Acc ~ Coh + Speed + PatternType + Coh*Speed*PatternType + (1|SubID)
...
form.acc.cloglog<- Acc ~ Coh + Speed + PatternType + Coh*Speed*PatternType + (1|SubID)
...
model.empty.rt <- lmer(formula = form.empty, data = df,REML=FALSE,na.omit=TRUE)
```
